...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div class="min-w-0">
                <h2 class="text-xl sm:text-2xl font-semibold text-gray-900">Nuevo producto</h2>
                <p class="text-sm text-gray-600">Crea un producto para asociarlo a garantías.</p>
            </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="{{ route('admin.productos.store') }}"
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Campos con * son obligatorios.</p>
                </div>
