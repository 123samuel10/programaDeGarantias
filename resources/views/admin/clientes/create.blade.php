<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1">
            <h2 class="font-semibold text-2xl text-gray-800">Nuevo cliente</h2>
            <p class="text-sm text-gray-500">Registra un cliente para asociarlo a garantías y seguimientos.</p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.clientes.store') }}"
                  ...
                  x-data="{ tipo: '{{ old('tipo_cliente','persona') }}' }">
                @csrf
                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Completa los datos básicos y de contacto.</p>
                        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-1">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Selecciona si es persona o empresa.</p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <label class="relative cursor-pointer">
                                    <input type="radio" name="tipo_cliente" value="persona"
                                           class="peer sr-only"
                                           x-model="tipo">
                                    <div class="p-4 rounded-2xl border border-gray-200 peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-100">
                                        <div class="flex items-center justify-between">
                                            <div class="font-semibold text-gray-900">Persona</div>
                                            <span class="text-xs px-2 py-1 rounded-full bg-gray-100 text-gray-600 peer-checked:bg-blue-50 peer-checked:text-blue-700">
                                                Natural
                                            </span>
                                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="nombre_contacto" value="{{ old('nombre_contacto') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input name="telefono_alterno" value="{{ old('telefono_alterno') }}"
                                       class="mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="pais" value="{{ old('pais','Colombia') }}"
                                       class="mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <textarea name="notas" rows="4"
                                      class="mt-1 w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Ej: Cliente frecuente, solicita soporte rápido, etc.">{{ old('notas') }}</textarea>
