        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->check() && auth()->user()->email === 'admin@gmail.com')
                        ...
                        <x-nav-link :href="route('admin.garantias.index')" :active="request()->routeIs('admin.garantias.*')">
                            Garantías
                        </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4
                            ...
                            <div class="text-left">
                                <div class="text-sm font-semibold text-gray-700 leading-4">
                                    {{ Auth::user()->name }}
                                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->check() && auth()->user()->email === 'admin@gmail.com')
                ...
                <x-responsive-nav-link :href="route('admin.garantias.index')" :active="request()->routeIs('admin.garantias.*')">
                    Garantías
                </x-responsive-nav-link>
